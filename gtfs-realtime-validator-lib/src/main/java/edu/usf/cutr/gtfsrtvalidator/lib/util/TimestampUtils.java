...
public class TimestampUtils {
    ...
    /**
     * Returns true if the timestampSec is too far in the future based on the provided current time
     * (in milliseconds), the provided current timestampSec (in POSIX time) and the provided tolerance in seconds, or false
     * if it's not too far in the future.
     *
     * @param currentTimeMillis current time, in milliseconds
     ...
     * @return true if the timestampSec is too far in the future based on the provided currentTimeMillis (in milliseconds),
     * the provided current timestampSec (in POSIX time) and the provided tolerance in seconds, or false if it's not too
     * far in the future.
     */
    public static boolean checkInFuture(long currentTimeMillis, long timestampSec, long toleranceSec) {
